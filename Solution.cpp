...
float Convert_in_number(string& s, int index1, int index2) // ïðåîáðàçóåò ñòðîêó â ÷èñëî 
{
    int i, j, b = 0;
    double x = 0;
    ...
    if (b) // åñëè ÷èñëî äðîáíîå
        return x / pow(10, b);
    else
        return x;
}

void Find_brackets(string& s) // ïîèñê ñêîáîê çàïèñûâàåò èíäåêñû â ìàññèâ
{
    // çàïèñü ñêîáîê íàñòðîåíà êàê ïðèîðèòåòíàÿ
    int i, i1;
...
void Find_signs(string& s, int begin, int end) // ïîèñê ìàò.çíàêîâ çàïèñûâàåò èíäåêñû â ìàññèâ
{
    // çàïèñü çíàêîâ â ïðèîðèòåòíîñòè
...
void Find_sings_and_brackets(string& s) // ïåðåäåëàòü ïîèñê çíàêîâ
{
    int i = 0, i1 = 0, temp = 0;
    vector<int> indexs;
    Find_brackets(s);
